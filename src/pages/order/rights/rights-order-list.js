...
class RightsOrderListForm extends Component {
  state = {
                ...
                <Row>
                  <Col span={12}>
                    <FormItem
                      ...
                      label="退货运单号"
                    >
                      {getFieldDecorator('returnGoodsAirwayBill')(
                        <Input />
                      )}
                    </FormItem>
                  </Col>
...
const RightsOrderList = Form.create()(RightsOrderListForm);

export default RightsOrderList;
